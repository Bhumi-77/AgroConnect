      ...
      <div className="marketplace-container" style={{
        ...
        <div className="crop-grid" style={{
          ...
          {filtered.map((c) => (
            ...
            >
              <div className="crop-card-content" style={{
                display: 'flex',
                justifyContent: 'space-between',
                gap: '16px'
              }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      {t('qty')}: {c.inventory?.available ?? c.quantity}
                    </span>
                    {c.farmer?.isVerified && (
                      <span style={{
                        padding: '6px 12px',
                ...
                <div className="crop-actions" style={{
                  ...
                  {user?.role === 'BUYER' && (
                    <Link
                      ...
                      onMouseOver={(e) => {
                        e.target.style.background = '#3d6630';
                      }}
                      onMouseOut={(e) => {
                        e.target.style.background = '#4a7c3b';
                      }}
                    >
                      {t('order')}
                    </Link>
