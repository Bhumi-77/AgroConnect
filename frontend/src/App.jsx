    ...
    <div className="nav">
      <div className="inner">
        ...
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          <select className="input" style={{ width: 140, padding: '8px 10px' }} value={i18n.language} onChange={(e)=>setLang(e.target.value)}>
          ...
          {user ? (
            <>
              <Link to="/profile" className="badge" style={{ background:'#ffffff22', color:'#fff' }}>{user.fullName} • {user.role}</Link>
