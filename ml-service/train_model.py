...
CSV_PATH = "data/fruits_vegetables_prices.csv"
MODEL_PATH = "model.joblib"

EXPECTED_NOHEADER_COLS_6 = ["product", "date", "unit", "min_price", "max_price", "avg_price"]
EXPECTED_NOHEADER_COLS_5 = ["product", "date", "unit", "min_price", "max_price"]
...
def main():
    ...
    if looks_like_first_row_became_header(df.columns):
        ...
        if df.shape[1] == 6:
            ...
            raise ValueError(f"CSV has {df.shape[1]} columns; expected 5 or 6.")

    rename_map = {
        "Product_Name": "product", "Product": "product", "cropName": "product",
        "Date": "date", "Unit": "unit", "Min": "min_price", "Max": "max_price",
        "Average": "avg_price", "Avg": "avg_price", "Price": "avg_price",
    }
